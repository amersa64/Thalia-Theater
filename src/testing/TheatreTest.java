...
//			}
//		}
//		for (int i = 0; i < shows[1].getSeating_info().getSections()[0].getRows()[0].getSeats().length; i++){
//			shows[1].getSeating_info().getSections()[0].getRows()[0].getSeats()[i].setTaken(true);
//		}
//		for (int l = 0; l < shows[1].getSeating_info().getSections()[0].getRows().length; l ++){
//			System.out.println(shows[1].getSeating_info().getSections()[0].getRows()[l].toString());
//		}
//		for (int m = 0; m < shows[0].getSeating_info().getSections()[0].getRows().length; m ++){
//			System.out.println(shows[0].getSeating_info().getSections()[0].getRows()[m].toString());
//		}
//	}
//
//	@Test
