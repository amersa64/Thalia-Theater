...
public class TestViewOrdersBetweenDates {
	...
	public void testViewShowsBetweenDates(){
		...
		seat01 = theatre1[0].findSeatByCid("52");
		seat02 = theatre1[0].findSeatByCid("53");

		Seat[] seats0 = {seat01,seat02};
		...
		seat11 = theatre2[1].findSeatByCid("190");
		seat12 = theatre2[1].findSeatByCid("191");
